...
class Game(object):
    ...
    def run(self):
        ...
        while True:
            ...
            try:
                for i in range(0, 3):
                    ...
                    # 获取落子位置
                    action = func_timeout(60.0, self.current_player.get_move,
        ...
        global_es_time = (global_end_time - global_start_time).seconds
        self.board.display(step_time, total_time)
        print('\nThe total time of this game is {}s\n'.format(global_es_time))
